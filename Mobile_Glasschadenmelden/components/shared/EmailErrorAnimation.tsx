      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 text-center">
            ...
            {/* Title */}
            <h2
              className={`text-lg font-bold text-slate-800 mb-2 transition-all duration-500 ${
            ...
            {email && (
              <p
                className={`text-sm text-red-600 font-semibold mb-1 break-all transition-all duration-500 ${
                  showContent ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
                }`}
            ...
            <p
              className={`text-sm text-slate-600 mb-5 transition-all duration-500 ${
                showContent ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}
            ...
            >
              <button
                onClick={handleClose}
                className="w-full py-3 px-4 bg-slate-100 active:bg-slate-200 text-slate-700 font-medium rounded-xl transition-colors"
              >
                Andere E-Mail verwenden
              </button>
              <Link
                href="/login"
                className="w-full py-3 px-4 bg-gradient-to-r from-red-500 to-rose-600 active:from-red-600 active:to-rose-700 text-white font-medium rounded-xl transition-all text-center"
              >
                Zur Anmeldung
              </Link>
            </div>
