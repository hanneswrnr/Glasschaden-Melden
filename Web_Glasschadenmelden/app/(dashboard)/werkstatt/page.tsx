  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {/* Welcome */}
        <div className="relative overflow-hidden bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 rounded-2xl p-8 mb-8 animate-fade-in-up shadow-lg">
