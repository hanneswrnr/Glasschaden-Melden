...
export function SuccessAnimation({
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col items-center gap-4 p-8 rounded-3xl bg-white shadow-2xl ring-4 ${colors.ring} transition-transform duration-300 ${
      ...
      >
        ...
        {/* Message */}
        <p className={`text-lg font-semibold ${colors.text} text-center max-w-xs`}>
          {message}
        </p>
      </div>
    </div>
