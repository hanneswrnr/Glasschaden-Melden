    ...
    <div className="border-t border-slate-200 bg-white">
      ...
      <div className="p-3 flex items-end gap-2">
        ...
        <button
          ...
          className="flex-shrink-0 w-10 h-10 rounded-xl bg-slate-100 active:bg-slate-200 flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <button
          ...
          className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
            canSend
              ? `${roleColors.badge} active:scale-95`
