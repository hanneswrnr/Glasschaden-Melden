          ...
          <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-xl">
            <div className="p-6 text-center">
              ...
              <p className="text-slate-600">
                Auftrag <span className="font-mono font-semibold text-red-600">{deleteConfirm.auftragsnummer}</span> von <span className="font-semibold">{deleteConfirm.claimName}</span> wird in den Papierkorb verschoben. Du kannst ihn dort wiederherstellen oder endgültig löschen.
              </p>
            </div>
