...
const ERROR_CONFIG = {
  ...
  email_not_confirmed: {
    ...
    hint: 'Bitte prüfen Sie Ihr Postfach und bestätigen Sie Ihre E-Mail.',
  },
  user_not_found: {
      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            >
              ...
              <div className="animate-shake">
                ...
                <div className="relative w-20 h-20 mx-auto bg-gradient-to-br from-red-500 to-rose-600 rounded-full flex items-center justify-center shadow-xl">
                  ...
                  {/* X badge */}
                  <div className="absolute -top-1 -right-1 w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-red-500">
            ...
            {/* Title */}
            <h2
              className={`text-xl font-bold text-slate-800 mb-2 transition-all duration-500 ${
            ...
            {/* Hint */}
            <p
              className={`text-sm text-slate-500 mb-6 transition-all duration-500 ${
                showContent ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}
            ...
            <button
              onClick={handleClose}
              className={`w-full py-4 px-6 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-semibold rounded-2xl shadow-lg transition-all duration-500 transform hover:scale-[1.02] active:scale-[0.98] ${
                showContent ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
              }`}
